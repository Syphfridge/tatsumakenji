// Supply & Demand Simulation – Full Layout + UI Polish
...
function getCanvasWidth() {
  // Almost the whole browser width
...
function applyTheme() {
  ...
  // Optional: style inputs a bit in dark mode
...
function setup() {
  ...
  showLegendCheckbox.position(20, baseY + 185);
  showInfoCheckbox.position(220, baseY + 185);
...
// --- keep canvas full width when resizing ---
...
function resetDefaults() {
  ...
  // do not touch scenarioSelect here
}
